    ...
    const fetchReport = async () => {
      ...
      try {
        ...
        const diag = {
          ...
          nota_t: scoringJson.blocos?.T?.nota,
          nota_geral: scoringJson.nota_geral?.valor,
          classificacao_a: scoringJson.blocos?.A?.classificacao,
          classificacao_s: scoringJson.blocos?.S?.classificacao,
          classificacao_au: scoringJson.blocos?.Au?.classificacao,
          classificacao_t: scoringJson.blocos?.T?.classificacao,
          ...
          <div className="md:col-span-2 bg-[#171717] border border-[#262626] rounded-xl p-6 print-exact break-inside-avoid flex flex-col justify-center">
            ...
            <div className="space-y-5">
              {[
                ...
                { label: 'Transformar (T)', nota: data.nota_t },
              ].map((item, idx) => (
                <div key={idx}>
