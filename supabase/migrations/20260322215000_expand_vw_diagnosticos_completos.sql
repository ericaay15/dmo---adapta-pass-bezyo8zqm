-- Removemos a view existente caso ela exista para podermos recriá-la com novas colunas e tipos
DROP VIEW IF EXISTS public.vw_diagnosticos_completos;

-- Criamos a view expandida com todas as perguntas, notas e dados qualitativos
...
SELECT
    ...
    CAST(d.respostas_json->>'A2' AS INTEGER) AS INTEGER,
